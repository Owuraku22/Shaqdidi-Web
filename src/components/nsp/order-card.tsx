    ...
    return (
      <>
        <div className="relative w-full bg-gradient-to-b from-black to-transparent bg-opacity-20 rounded-t-2xl">
          <img
            src={details.joint_image}
            alt={details.joint_name}
        ...
        <div className="grid gap-4 py-4 px-7">
          <div className="flex flex-col gap-4">
            ...
            <span className="col-span-3 border rounded-lg px-3 py-2">
              {" "}
              GHC {details.amount}
            </span>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <span className="font-medium text-red-500">
              {details.staff_name ? "Staff" : "Personnel"} Name
            </span>
            <span className="col-span-3 border rounded-lg px-3 py-2">
              {details.name || details.staff_name || "No personnel assigned"}
            </span>
          </div>
          <div className="flex flex-col gap-4">
            <span className="font-medium text-red-500">Phone Number</span>
            <span className="col-span-3 border rounded-lg px-3 py-2">
              {details.personnel_phone_number ||
                details.staff_phone_number ||
